...
namespace Managers
{
    public partial class LevelConfigData
    {
        ...
        private static readonly string[] ColumnNames = CreateNames(LevelConfig.Width);
        private static readonly string[] RowNames = CreateNames(LevelConfig.Height);
        ...
        private void DrawFillTools()
        {
            ...
            GUILayout.Label("Fill Tools", EditorStyles.boldLabel);
        ...
        private void FillColumns()
        {
            ...
            for (int x = from; x <= to; x++)
            {
                ...
                {
                    LevelConfig.Grid[x, y] = new BoxData
                    {
                        Color = _fillColor,
